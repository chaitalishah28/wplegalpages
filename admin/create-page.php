  ...
  <div id="lp_generalid_right" class="postbox ">
	...
	$result = $wpdb->get_results("select * from $lpObj->tablename");
		foreach($result as $ras){
			?>
            <li><span id="legalpages<?php echo $ras->id;?>"><a class="myLink" href="<?php echo esc_url($baseurl);?>/wp-admin/admin.php?page=<?php echo $page;?>&lp-type=<?php echo $lptype;?>&template=<?php echo $ras->id;?>"><?php echo $ras->title;?> &raquo;</a></span></li>
            <?php }?>
